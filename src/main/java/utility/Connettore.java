...
public final class Connettore {
	...
	private final String URL = "jdbc:mysql://localhost:3306/torneo_db?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
